 ...
 * mc - int - the amount of changes that happend in the graph
 * nextKeyEdge - int - a counter used to give unique id's to all edges
 * nodes - Hashmap<Integer, api.NodeData> - a hashmap off all the nodes in the graph
 * edges - Hashmap<Integer, api.NodeData> - a hashmap off all the edges in the graph
 */
public class DWG implements api.DirectedWeightedGraph {
    ...
    public Iterator<api.NodeData> nodeIter() {
        ...
        return new Iterator<>() {
            ...
            @Override
            public void forEachRemaining(Consumer<? super api.NodeData> action) {
    ...
    public Iterator<api.EdgeData> edgeIter() {
        ...
        return new Iterator<>() {
            ...
            @Override
            public void forEachRemaining(Consumer<? super api.EdgeData> action) {
                Iterator.super.forEachRemaining(action);
            }
        };
    }
